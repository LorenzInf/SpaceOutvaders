...
public class MainMenu extends GraphicalWindow {
    ...
    public MainMenu(ViewController viewController, ProgramController programController) {
        ...
        images = new BufferedImage[]{
                ...
                load("main_screen_question_mark_selected"), //4
    ...
    public void draw(DrawTool drawTool){
        ...
        switch(programController.getWindow().getMainMenuIndex()){
            case 1 -> drawTool.drawImage(images[0], 0 ,0);
            case 2 -> drawTool.drawImage(images[1], 0 ,0);
            case 3 -> drawTool.drawImage(images[2], 0 ,0);
            case 4 -> drawTool.drawImage(images[3], 0 ,0);
            case 5 -> drawTool.drawImage(images[4], 0 ,0);
        }
    }
}
